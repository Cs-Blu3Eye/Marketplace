<!-- resources/views/layouts/navigation.blade.php (Navigasi utama dari Laravel Breeze) -->
<!-- Ini adalah bagian dari Breeze, pastikan ada di folder resources/views/layouts -->
